...
if (isset($_POST['update'])) {
    ...
    $tanggal_selesai = !empty($_POST['tanggal_selesai'])
        ? mysqli_real_escape_string($conn, $_POST['tanggal_selesai'])
        : NULL;


    // ========================================
    // Simpan data lama untuk kebutuhan log
    // ========================================
    $inventaris_id_lama = $data['inventaris_id'];
    $status_lama = $data['status'];


    // ========================================
    // Ambil data perangkat LAMA
    // ========================================
    $query_perangkat_lama = mysqli_query($conn, "
        SELECT kode_aset, nama_hardware
        FROM inventaris
        WHERE id = '$inventaris_id_lama'
    ");

    $perangkat_lama = mysqli_fetch_assoc($query_perangkat_lama);
    ...
    // ========================================
    // Jika update maintenance berhasil
    // ========================================
    if ($query_update) {
        ...
        // ========================================
        // Ambil data perangkat setelah update
        // ========================================
        $query_perangkat_baru = mysqli_query($conn, "
            SELECT kode_aset, nama_hardware
            FROM inventaris
            WHERE id = '$inventaris_id'
        ");

        $perangkat_baru = mysqli_fetch_assoc($query_perangkat_baru);


        $nama_hardware = $perangkat_baru
            ? $perangkat_baru['nama_hardware']
            : 'Perangkat';

        $kode_aset = $perangkat_baru
            ? $perangkat_baru['kode_aset']
            : '-';
        ...
        if ($status == "Selesai") {
            ...
            logAktivitas(
                ...
                " telah selesai diperbaiki dan kembali tersedia."
            );

        }

        // Jika status masih dalam proses
        else {
            ...
            logAktivitas(
                ...
                " dengan kode aset " . $kode_aset .
                " telah diperbarui. Status: " . $status . "."
            );
        }
            ...
            <form method="POST">
                ...
                <div class="form-group">
                    ...
                    <textarea
                        name="kerusakan"
                        required
                    ><?= htmlspecialchars($data['kerusakan']); ?></textarea>
                ...
                <div class="form-group">
                    ...
                    <select name="keparahan">
                        ...
                        <option
                            value="Rendah"
                            <?= ($data['keparahan'] == "Rendah") ? "selected" : ""; ?>
                        >
                            Rendah
                        </option>
                        ...
                        <option
                            value="Sedang"
                            <?= ($data['keparahan'] == "Sedang") ? "selected" : ""; ?>
                        >
                            Sedang
                        </option>
                        ...
                        <option
                            value="Tinggi"
                            <?= ($data['keparahan'] == "Tinggi") ? "selected" : ""; ?>
                        >
                            Tinggi
                        </option>
                ...
                <div class="form-group">
                    ...
                    <textarea
                        name="tindakan"
                    ><?= htmlspecialchars($data['tindakan'] ?? ''); ?></textarea>
                ...
                <div class="form-group">
                    ...
                    <select name="status">
                        ...
                        <option
                            ...
                            <?= ($data['status'] == "Dalam Perbaikan") ? "selected" : ""; ?>
                        >
                            Dalam Perbaikan
                        </option>
